...
const lightOptions: ThemeOption = {
  ...
  map: {
    itemStyle: { areaColor: "#eeeeee", borderColor: "#aaaaaa", borderWidth: 0.5 },
    label: { color: "#ffffff" },
    emphasis: {
      itemStyle: { areaColor: "rgba(63,177,227,0.25)", borderColor: "#3fb1e3", borderWidth: 1 },
      label: { color: "#3fb1e3" },
    },
  },
  geo: {
  ...
  timeline: {
    ...
    itemStyle: { color: "#626c91", borderWidth: 1 },
    controlStyle: { color: "#626c91", borderColor: "#626c91", borderWidth: 0.5 },
    checkpointStyle: { color: "#3fb1e3", borderColor: "#3fb1e3" },
    label: { color: "#626c91" },
    emphasis: {
