export default {
  ...
  textStyle: {},
  title: { textStyle: { color: "#ffffff" }, subtextStyle: { color: "#dddddd" } },
  ...
  map: {
    ...
    label: { color: "#893448" },
    emphasis: {
      itemStyle: { areaColor: "rgba(255,178,72,1)", borderColor: "#eb8146", borderWidth: 1 },
      label: { color: "rgb(137,52,72)" },
    },
  },
  geo: {
    itemStyle: { areaColor: "#f3f3f3", borderColor: "#999999", borderWidth: 0.5 },
  ...
  timeline: {
    lineStyle: { color: "#87f7cf", width: 1 },
    itemStyle: { color: "#87f7cf", borderWidth: 1 },
    controlStyle: { color: "#87f7cf", borderColor: "#87f7cf", borderWidth: 0.5 },
    checkpointStyle: { color: "#fc97af", borderColor: "#fc97af" },
    label: { color: "#87f7cf" },
    emphasis: {
      itemStyle: { color: "#f7f494" },
      controlStyle: { color: "#87f7cf", borderColor: "#87f7cf", borderWidth: 0.5 },
      label: { color: "#87f7cf" },
    },
  },
  visualMap: { color: ["#fc97af", "#87f7cf"] },
  dataZoom: {
  ...
  markPoint: { label: { color: "#293441" }, emphasis: { label: { color: "#293441" } } },
}
